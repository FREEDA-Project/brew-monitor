...
highConsumptionService(mongodb_batch_olbia,medium,worker2,0.896).
highConsumptionService(mongodb_batch_torino,medium,worker2,0.896).
highConsumptionService(analyzer,large,worker3,0.896).
highConsumptionService(analyzer,large,worker2,0.896).
highConsumptionService(mongodb_history,medium,worker2,0.896).
...
highConsumptionService(data_gather_olbia,tiny,worker2,0.896).
highConsumptionService(data_gather_olbia,tiny,worker3,0.896).
highConsumptionService(data_gather_torino,tiny,worker2,0.896).
highConsumptionService(data_gather_torino,tiny,worker3,0.896).
